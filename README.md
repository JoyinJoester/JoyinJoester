...
<!-- snake -->
  <picture>
    <source media="(prefers-color-scheme: dark)" srcset="https://github.com/JoyinJoester/JoyinJoester/blob/output/github-snake.svg" />
...
<font><h1>注意事项<h1></font>
  ...
  <font><h1>入职门槛<h1></font>
	<ul>
    <li>精通Linux，Windows，Mac等系统的使用</li>
	<li>精通Photoshop，Blender的操作</li>
	<li>熟练运用Java，C/C++,C#,Kotlin等语言</li>
	<li>本科以上学历</li>
	</ul>
